const acrylic = "/acrylic-wall-sculpture.jpg";
const backMan = "/back-man-figurines.jpg";
const brandPoster = "/brand-poster.jpg";
const centerTables = "/center-tables.jpg";
const centerTables2 = "/center-tables-2.jpg";
const fancyChairs = "/fancy-chairs.jpg";
const figurines = "/figurines.jpg";
const figurines2 = "/figurines-2.jpg";
const foreignCouch = "/foreign-couch.jpg";
const frames = "/frames.jpg";
const goldcurl = "/goldcurl-ornaments.jpg";
const heroCover = "/hero-cover.jpg";
const kaws = "/kaws.jpg";
const mirror = "/mirror.jpg";
const plasticVase = "/plastic-vase-flowers.jpg";
const portfolioStrip = "/portfolio-strip.jpg";
const renoLuxeLogo = "/reno-luxe-logo.jpg";
const sideStool = "/side-stool.jpg";
const standingLamps = "/standing-lamps.jpg";
const swingChairs = "/swing-chairs.jpg";
const tripod = "/tripod-flame-aroma.jpg";
const viju1 = "/viju-1.jpg";
const viju2 = "/viju-2.jpg";
const viju3 = "/viju-3.jpg";
const viju4 = "/viju-4.jpg";
const visualizationLamp = "/visualization-lamp.jpg";
const sceneBedroom = "/scene-bedroom.jpg";
const sceneLiving = "/scene-living.jpg";
const sceneOffice = "/scene-office.jpg";
const sceneRetail = "/scene-retail.jpg";
