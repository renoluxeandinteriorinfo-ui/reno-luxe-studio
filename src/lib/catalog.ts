const asset = (name: string) => `/optimized/${name}`;

const acrylic = asset("acrylic-wall-sculpture.jpg");
const backMan = asset("back-man-figurines.jpg");
const brandPoster = asset("brand-poster.jpg");
const centerTables = asset("center-tables.jpg");
const centerTables2 = asset("center-tables-2.jpg");
const fancyChairs = asset("fancy-chairs.jpg");
const figurines = asset("figurines.jpg");
const figurines2 = asset("figurines-2.jpg");
const foreignCouch = asset("foreign-couch.jpg");
const frames = asset("frames.jpg");
const goldcurl = asset("goldcurl-ornaments.jpg");
const heroCover = asset("hero-cover.jpg");
const kaws = asset("kaws.jpg");
const mirror = asset("mirror.jpg");
const plasticVase = asset("plastic-vase-flowers.jpg");
const portfolioStrip = asset("portfolio-strip.jpg");
const renoLuxeLogo = asset("reno-luxe-logo.jpg");
const sideStool = asset("side-stool.jpg");
const standingLamps = asset("standing-lamps.jpg");
const swingChairs = asset("swing-chairs.jpg");
const tripod = asset("tripod-flame-aroma.jpg");
const viju1 = asset("viju-1.jpg");
const viju2 = asset("viju-2.jpg");
const viju3 = asset("viju-3.jpg");
const viju4 = asset("viju-4.jpg");
const visualizationLamp = asset("visualization-lamp.jpg");
const sceneBedroom = asset("scene-bedroom.jpg");
const sceneLiving = asset("scene-living.jpg");
const sceneOffice = asset("scene-office.jpg");
const sceneRetail = asset("scene-retail.jpg");
