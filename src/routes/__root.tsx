...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Reno Luxe & Interior — …beyond renovation, into luxury" },
      {
        name: "description",
        content:
          "Luxury interior design, renovation, styling and premium décor by Reno Luxe & Interior. Worldwide product delivery, installation within Nigeria.",
      },
      { name: "author", content: "Reno Luxe & Interior" },
      { property: "og:site_name", content: "Reno Luxe & Interior" },
